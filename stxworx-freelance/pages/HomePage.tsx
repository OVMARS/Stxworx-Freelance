          ...
          <div className="glass-panel p-1 rounded-3xl animate-slide-up">
            <div className="bg-[#020617]/80 rounded-[22px] py-16 px-6 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto relative z-10">
                ...
                <div className="group relative overflow-hidden bg-[#0b0f19] p-8 rounded-2xl border border-white/10 hover:border-blue-500 transition-all duration-300 text-left flex flex-col justify-between">
