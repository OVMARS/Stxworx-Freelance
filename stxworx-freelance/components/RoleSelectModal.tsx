...
const RoleSelectModal: React.FC<RoleSelectModalProps> = ({ open, onSelect }) => {
  if (!open) return null;
        ...
        <div className="relative bg-[#0b0f19] border border-white/10 rounded-2xl p-8 shadow-[0_0_80px_rgba(249,115,22,0.08)]">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button
              ...
              className="group relative flex flex-col items-center gap-4 p-6 rounded-xl border border-white/10 bg-[#020617]/60 hover:border-orange-500/40 hover:bg-orange-500/5 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500/50"
            >
            ...
            <button
              ...
              className="group relative flex flex-col items-center gap-4 p-6 rounded-xl border border-white/10 bg-[#020617]/60 hover:border-blue-500/40 hover:bg-blue-500/5 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
            >
